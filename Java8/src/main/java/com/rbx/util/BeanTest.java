...
import com.rbx.util.ZhouyuApplicationContext;
import com.rbx.entity.UserInfo;
    ...
    public static <T> T map2Bean(Map<String, String> map, Class<T> class1) {
        ...
        public void ZhouyuApplicationContext(Class<?> configClass) throws ClassNotFoundException {
            ...
            if (configClass.isAnnotationPresent(ComponentScan.class)) {
                ...
                ClassLoader classLoader = com.rbx.util.ZhouyuApplicationContext.class.getClassLoader();
